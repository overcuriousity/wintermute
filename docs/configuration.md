...
Controls how memories are injected into the system prompt. Only the top-K most relevant memories are injected each turn based on the current conversation context.
