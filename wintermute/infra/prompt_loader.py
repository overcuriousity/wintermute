...
REQUIRED_FILES = [
    ...
    "SUB_SESSION_SCAFFOLDING.txt",
    "CONVERGENCE_STAGE1.txt",
...
NL_TRANSLATION_FILES = [
    "NL_TRANSLATOR_TASK.txt",
    "NL_TRANSLATOR_WORKER_DELEGATION.txt",
    "NL_TRANSLATOR_SKILL.txt",
]
