...
# ═══════════════════════════════════════════════════════════════════════
#
# Generated by setup.sh. See config.yaml.example for full documentation.
...
YAML
      ...
      cat <<'YAML'
# ── Whisper (Voice Transcription, disabled) ───────────────────────────
# whisper:
#   enabled: true
...
YAML
    ...
    cat <<'YAML'
# ── Signal (disabled) ─────────────────────────────────────────────────
# Uncomment and fill in to enable. See docs/signal-setup.md.
# signal:
#   enabled: true
...
YAML
    ...
    # ── 6. Lite Mode ──
    cat <<'YAML'
# ── Lite Mode (Global Sub-Session Toggle) ─────────────────────────────
...
YAML
    ...
    cat <<'YAML'
# ── Skill Storage ─────────────────────────────────────────────────────
# Inherits memory backend by default. Uncomment to override.
# skills:
#   backend: "local_vector"
#   qdrant:
#     collection: "wintermute_skills"
...
YAML
    ...
    # ── 12. Tool Profiles ──
    cat <<'YAML'
# ── Tool Profiles (Named Sub-session Presets) ─────────────────────────
tool_profiles:
  researcher:
...
YAML
    ...
    # ── 18. Reflection ──
    cat <<'YAML'
# ── Reflection Cycle (Feedback Loop) ─────────────────────────────────
reflection:
  enabled: true
  batch_threshold: 10
...
YAML
    ...
    # ── 19. Self-Model ──
    cat <<'YAML'
# ── Self-Model (Operational Self-Awareness) ──────────────────────────
self_model:
  enabled: true
